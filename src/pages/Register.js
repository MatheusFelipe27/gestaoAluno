...
function Register() {
    ...
    function getMatricula() {
        ...
        for (let i = 0; i < alunos.length; i++) {
            if (parseInt(alunos[i].matricula) > answer) answer = parseInt(alunos[i].matricula)
        }
        return answer + 1
    }
    ...
    const registrarAluno = (e) => {
        ...
        if (novoAluno.avaliacao == "" || +novoAluno.avaliacao < 0 || +novoAluno.avaliacao > 10) {
            checar = true;
            ...
            <div className="registerDiv">
                ...
                <div className="registerContainer">
                    <form className="registerForm">
                        ...
                        <label className="registerLabel">
                            Avaliação
                            <input className="registerInput" value={avaliacao}
